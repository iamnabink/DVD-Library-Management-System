...
namespace ADCW.Controllers
{
    ...
    public class ProducersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProducerId,ProducerFirstName,ProducerLastName")] Producer producer)
        {
            if (ModelState.IsValid)
            {
                ...
                if (TempData.ContainsKey("VideoDetailsModel") && (bool)TempData["VideoDetailsModel"])
                {
                    TempData["SuccessMsg"] = "Added Producer";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProducerId,ProducerFirstName,ProducerLastName")] Producer producer)
        {
            if (ModelState.IsValid)
            {
